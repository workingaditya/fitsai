  ...
  theme: {
    extend: {
      colors: {
        ...
        sidebar: {
          DEFAULT: 'var(--color-sidebar)', // gray-800
      ...
      spacing: {
        'sidebar': 'var(--spacing-sidebar)', // 280px
        'sidebar-collapsed': 'var(--spacing-sidebar-collapsed)', // 64px
      },
      width: {
        'sidebar': 'var(--spacing-sidebar)', // 280px
        'sidebar-collapsed': 'var(--spacing-sidebar-collapsed)', // 64px
      ...
      animation: {
        ...
        'pulse-loading': 'pulse 2s cubic-bezier(0.4, 0, 0.6, 1) infinite',
      },
      keyframes: {
        fadeIn: {
